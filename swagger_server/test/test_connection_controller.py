...
class TestConnectionController(BaseTestCase):
    ...
    def test_delete_connection(self):
        ...
        response = self.client.open(
            '/YufengXin/SDX-Controller/1.0.0/connection/{connectionId}'.format(connection_id=2),
            method='DELETE')
    ...
    def test_getconnection_by_id(self):
        ...
        """
        response = self.client.open(
            '/YufengXin/SDX-Controller/1.0.0/connection/{connectionId}'.format(connection_id=10),
            method='GET')
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_place_connection(self):
        ...
        body = Connection()
        response = self.client.open(
            '/YufengXin/SDX-Controller/1.0.0/conection',
            method='POST',
